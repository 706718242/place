...
let resultText = document.getElementById("result");
  var count=document.getElementById("OnMachine").rows.length;

//var mytable = document.getElementById("OnMachine").rows[31].cells[1].innerHTML;
...
for (let i = 0; i < count; i++) {
 iThRow= document.getElementById("OnMachine").rows[i].cells[1].innerHTML;
...
//Qty1=i;
  // table.rows[Qty1].scrollIntoView();

//PartN=tds[0].innerText;
PartN1=iThRow.substring(0, 20);
//Qty= tds[i+2].innerText;
//Balance= tds[i+3].innerText;
//Usage= tds[i+4].innerText;
...
function is_shortcut(ev) {
    ...
    var is_alternative_input = (is_windows && ev.ctrlKey && ev.altKey);
